...
class Component {
    ...
    /**
     * Indicate if this component got a explicit ID (otherwise one was autogenerated)
     * @var bool
     */
    private $got_explicit_id = false;
    ...
    /**
     * Return true if an ID has been set explicitly for this component.
     * @return bool
     */
    public function hasExplicitID() : bool {
        return $this->got_explicit_id;
    }
