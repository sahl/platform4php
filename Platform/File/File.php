...
/**
 * Datarecord object for storing files and information about files.
 * 
 * Also responsible for storing the files on disk.
 * 
...
class File extends Datarecord {
    ...
    public function getURL() : string {
        ...
        return '/Platform/File/php/file.php/'.Instance::getActiveInstanceID().'/'.$this->file_id.'/'.urlencode($this->filename);
    }
