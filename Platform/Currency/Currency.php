...
class Currency {
    ...
    /**
     * Get the currently enabled currencies
     * @return array
     */
    ...
    public static function isValidCurrency(string $currency) {
        return array_key_exists($currency, self::$currency_map);
    }
    ...
    /**
     * Set the currently enabled currencies. Pass an empty array to enable all currencies
     * @param array $currencies Currency codes to set as enabled.
     */
    public static function setEnabledCurrencies(array $currencies) {
