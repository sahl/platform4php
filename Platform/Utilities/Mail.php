...
class Mail extends Datarecord {
    ...
    protected static function buildStructure() {
        static::addStructure([
            new KeyType('mail_id'),
            new TextType('from_name', Translation::translateForUser('From (name)'), ['is_required' => true, 'is_searchable' => true]),
            new EmailType('from_email', Translation::translateForUser('From (email)'), ['is_required' => true, 'is_searchable' => true]),
            new TextType('to_name', Translation::translateForUser('To (name)'), ['is_required' => true, 'is_searchable' => true]),
            new EmailType('to_email', Translation::translateForUser('To (email)'), ['is_required' => true, 'is_searchable' => true]),
            new TextType('reply_to_name', Translation::translateForUser('Reply to (name)'), ['is_searchable' => true]),
            new EmailType('reply_to_email', Translation::translateForUser('Reply to (email)'), ['is_searchable' => true]),
