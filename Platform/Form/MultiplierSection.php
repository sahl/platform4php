...
class MultiplierSection extends Field {
    ...
    public function renderInput() {
        echo '<div data-fieldclass="'.$this->getFieldClass().'" class="'.$this->getFieldClasses().'" id="'.$this->getFieldIdForHTML().'" data-basename="'.$this->getName().'" '.$this->additional_attributes.'>';
        for ($i = 0; $i < count($this->value)+1; $i++) {
