...
class PasswordField extends Field {
    ...
    public function renderInput() {
        ...
        echo '<input data-fieldclass="'.$this->getFieldClass().'" class="'.$this->getFieldClasses().'" style="'.$this->getFieldStyleString().'"'.$placeholder.' type="password" name="'.$this->name.'" id="'.$this->getFieldIdForHTML().'" value="'.htmlentities($value, ENT_QUOTES).'"'.$this->additional_attributes.'>';
    }
}