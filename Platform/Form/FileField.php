...
class FileField extends Field {
    ...
    public function renderInput() {
        ...
        echo '<iframe id="'.$this->getFieldIdForHTML().'" data-name="'.$this->getName().'" class="platform_file_input_frame" src="/Platform/Form/php/file.php?form_name='.$this->getFormId().'&field_name='.$this->getName().'&file_id='.$value['file_id'].'&original_file='.$value['originalfile'].'" frameborder=0 width=100% height=36 style="vertical-align: top;"></iframe>';
    }
